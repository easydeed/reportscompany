...
**Key details:**
- **Full themes** (Classic, Modern, Elegant): Up to 21 pages including roadmap, marketing, negotiation, and timeline sections.
- **Compact themes** (Teal, Bold): 9 core pages — Cover, TOC, Aerial View, Property Details, Area Sales Analysis, Market Trends, Comparables, Range of Sales, Neighborhood Stats.
- Required pages that cannot be deselected: **Property Details** and **Sales Comparables**.

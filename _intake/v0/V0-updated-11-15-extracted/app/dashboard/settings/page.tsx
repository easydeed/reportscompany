...
export default function SettingsPage() {
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h1 className="font-display font-bold text-3xl mb-2 text-balance">Settings</h1>
      ...
      <Card className="border-border/50 bg-card hover:shadow-lg transition-shadow">
        ...
        <CardContent className="space-y-4">
          ...
          <Button variant="outline" className="bg-gradient-to-r from-primary to-primary/80 hover:opacity-90">
            Update Password
          </Button>
        </CardContent>
      </Card>

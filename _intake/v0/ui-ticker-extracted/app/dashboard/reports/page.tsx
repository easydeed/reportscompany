...
export default function ReportsPage() {
  ...
  const getStatusBadge = (status: string) => {
    const styles = {
      Published: "bg-green-500/10 text-green-600 dark:text-green-400 hover:bg-green-500/20",
      Draft: "bg-slate-500/10 text-slate-600 dark:text-slate-400 hover:bg-slate-500/20",
      Processing: "bg-blue-500/10 text-blue-600 dark:text-blue-400 hover:bg-blue-500/20",
      Failed: "bg-red-500/10 text-red-600 dark:text-red-400 hover:bg-red-500/20",
    }
            ...
            <TableBody>
              {filteredReports.length === 0 ? (
                ...
                filteredReports.map((report) => (
                  <TableRow key={report.id} className="hover:bg-muted/30 cursor-pointer group">
                    <TableCell>
                      <div>

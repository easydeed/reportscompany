      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          ...
          {state.recipients.length > 0 && (
            <div className="space-y-2">
              <Label className="text-sm">Recipients ({state.recipients.length})</Label>
              <div className="space-y-2 max-h-[300px] overflow-y-auto p-3 rounded-lg bg-muted/50 border border-border">

...
export default function BillingPage() {
  return (
    <div className="space-y-6 max-w-6xl">
      <div>
        <h1 className="font-display font-bold text-3xl mb-2">Billing</h1>
          ...
          {plans.map((plan) => (
            <Card key={plan.name} className={plan.current ? "border-primary border-2" : ""}>
              <CardHeader>
                ...
                <div className="text-3xl font-display font-bold">{plan.price}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center justify-between glass rounded-lg border border-border p-4">

    ...
    <div className="min-h-screen bg-background">
      ...
      <SectionWrapper className="py-20">
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="p-8 md:p-12 bg-gradient-to-br from-background to-muted/30 border-2">
                ...
                >
                  ...
                  {index < flowSteps.length - 1 && (
                    <div className="hidden md:block absolute top-6 left-[calc(50%+24px)] w-[calc(100%-48px)]">
                      <ArrowRight className="w-5 h-5 text-primary/40 mx-auto" />
                    </div>
                  )}
                </motion.div>
              ))}
      ...
      {/* KPI Strip */}
      <SectionWrapper className="py-16 bg-slate-950 text-white">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {kpis.map((kpi, index) => (
            ...
            >
              <div className="font-display text-4xl md:text-5xl font-bold text-primary mb-2">{kpi.value}</div>

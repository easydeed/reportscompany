...
export default function BrandingPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        <h1 className="font-display font-bold text-3xl mb-2 text-balance">Branding</h1>
        <p className="text-muted-foreground text-pretty">Customize your report appearance with your brand identity</p>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <div className="space-y-6">
          ...
          <Button className="w-full gap-2 bg-gradient-to-r from-primary to-primary/80 hover:opacity-90">
        ...
        <div>
          <Card className="sticky top-6 border-border/50 bg-card">
            ...
            <CardContent>
              <div className="aspect-[8.5/11] bg-muted/30 rounded-xl border border-border/50 p-6 space-y-4">

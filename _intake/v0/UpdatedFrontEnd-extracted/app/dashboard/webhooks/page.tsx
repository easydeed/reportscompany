  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="font-display font-bold text-3xl mb-2 text-balance">Webhooks</h1>
          <p className="text-muted-foreground text-pretty">Receive real-time notifications about report events</p>
        </div>

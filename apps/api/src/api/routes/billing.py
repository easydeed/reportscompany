    ...
    with db_conn() as (conn, cur):
        ...
        try:
            session = stripe.checkout.Session.create(
                ...
                success_url=f"{WEB_BASE}/app/settings/billing?checkout=success",
                cancel_url=f"{WEB_BASE}/app/settings/billing?checkout=cancelled",
                metadata={
                    "account_id": acc_id,
    ...
    with db_conn() as (conn, cur):
        ...
        try:
            portal_session = stripe.billing_portal.Session.create(
                customer=stripe_customer_id,
                return_url=f"{WEB_BASE}/app/settings/billing",
            )

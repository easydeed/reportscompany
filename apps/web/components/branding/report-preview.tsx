    ...
    <body>
      ...
      <div class="footer">
        <div class="footer-content">
          <div>
            <span class="footer-brand">${brandName}</span> • Market Intelligence
          </div>
          <div class="footer-contact">
            ${branding.contact_line1 || ""}${branding.contact_line1 && branding.contact_line2 ? " • " : ""}${branding.contact_line2 || ""}
            ${branding.website_url ? `<br/>${branding.website_url}` : ""}
          </div>
        </div>
      </div>
    </body>

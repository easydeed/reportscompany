        ...
        <div>
          ...
          <p className="text-xs text-green-600 dark:text-green-400">
            {isCompanyRep
              ...
              : "You're ready to manage your trial agents and track their activity."}
          </p>
        </div>
      </div>
    )
          ...
          <div className="flex items-start gap-3 p-3 rounded-xl bg-blue-50/80 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30">
            ...
            <div>
              ...
              <p className="text-xs text-blue-700 dark:text-blue-300 mt-0.5">
                Your branding (logo, colors) will appear on all reports generated by your trial agents.
              </p>
            </div>
          </div>
        )}
        ...
        {sponsoredCount > 0 && (
          <div className="flex items-center gap-3 p-3 bg-muted/30 rounded-xl border border-border/50">
            ...
            <span className="text-xs text-muted-foreground">
              You have <strong className="text-foreground font-semibold">{sponsoredCount}</strong> {isCompanyRep ? 'agent' : 'trial agent'}{sponsoredCount !== 1 ? 's' : ''}
            </span>
          </div>
        )}
      </CardContent>

  ...
  return (
    ...
    >
      <div className="space-y-6">
              ...
              {dayNames.map((day, index) => (
                <button
                  ...
                  className={cn(
                    ...
                    weeklyDow === index ? "bg-violet-600 text-white" : "bg-muted hover:bg-violet-100 dark:hover:bg-violet-900",
                  )}
                >
                  {day}
                </button>
              ...
              {Array.from({ length: 28 }, (_, i) => i + 1).map((day) => (
                <button
                  ...
                  className={cn(
                    ...
                    monthlyDom === day ? "bg-violet-600 text-white" : "bg-muted hover:bg-violet-100 dark:hover:bg-violet-900",
                  )}
                >
                  {day}
                </button>
        ...
        {/* Next Run Display */}
        <div className="flex items-center gap-2 rounded-lg bg-violet-50 px-3 py-2 text-sm text-violet-800 dark:bg-violet-950/50 dark:text-violet-300">

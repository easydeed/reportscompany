...
import { ArrowLeft, Building, Loader2, CheckCircle, Copy, UserPlus } from "lucide-react"
...
export default function NewCompanyPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await fetch("/api/proxy/v1/admin/companies", {
        method: "POST",
      ...
      if (!res.ok) {
        throw new Error(typeof data.detail === "string" ? data.detail : "Failed to create company")
      }
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-display font-bold text-foreground">Company Created</h1>
          </div>
        </div>
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground">
                {success.adminInvited
                  ...
                  : "You can invite a company admin later."}
              </p>
            </div>
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">Create a new Title Company account</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-2xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Master branding that cascades to all reps under this company</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <ImageUpload
              label="Company Logo"
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription className="mt-1.5">
                  {inviteAdmin
                    ? "The person who will manage reps and branding for this company"
                    : "You can invite a company admin later"}
                </CardDescription>
              </div>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  name="admin_email"
                  type="email"
                  placeholder="admin@pacificcoasttitle.com"

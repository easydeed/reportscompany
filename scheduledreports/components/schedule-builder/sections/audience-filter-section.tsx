  ...
  return (
    ...
    >
      <div className="space-y-4">
          ...
          {audienceOptions.map((option) => (
            <button
              ...
              className={cn(
                ...
                value === option.value ? "border-violet-500 bg-violet-50" : "border-border hover:border-violet-300",
              )}
            >
              <div>
        ...
        <div className="flex items-start gap-2 rounded-lg bg-violet-50 px-3 py-2 text-sm text-violet-800">
